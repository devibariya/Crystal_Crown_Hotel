...
<head>
  ...
  <title>Standard Rooms - Crystal Crown Hotel</title>
...
<body>
  ...
  <!-- Room Section -->
  <section class="py-5">
    <h2 class="section-title">Available Standard Rooms</h2>
    ...
    <div class="container">
      <div class="row g-4">
        ...
        $sql = "SELECT * FROM room_manage WHERE Room_type = 'Standard'";
  ...
  <input type="submit" 
         ...
         ' . ($isAvailable ? '' : 'disabled') . '>
          ...
          echo '<p class="text-center">No Standard rooms available at the moment.</p>';
        }
