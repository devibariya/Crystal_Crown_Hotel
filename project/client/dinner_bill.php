...
if ($orderId <= 0) {
    die("Invalid Dinner order ID.");
}

// Fetch order details
$sql = "SELECT * FROM dinner_orders WHERE id = $orderId";
$result = mysqli_query($conn, $sql);

if (!$result || mysqli_num_rows($result) == 0) {
    die("Dinner order not found.");
}
...
<div class="section">
<div class="section-title">Dinner Details</div>
<div class="info-grid">
...
<p>Thank you for dining with Crystal Crown Hotel 🍽️</p>
<p>We hope you enjoyed your lunch.</p>
</div>
</div>
