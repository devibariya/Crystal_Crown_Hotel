...
<head>
  ...
  <title>Family Rooms - Crystal Crown Hotel</title>
...
<body>
  ...
  <!-- Room Section -->
  <section class="py-5">
    <h2 class="section-title">Available Family Rooms</h2>
    ...
    <div class="container">
      <div class="row g-4">
        ...
        $sql = "SELECT * FROM room_manage WHERE Room_type = 'Family room'";
        ...
        if ($result && mysqli_num_rows($result) > 0) {
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            $acType = ucfirst($row['Room_category']); // AC or Non-AC
  ...
  <input type="submit" 
         ...
         ' . ($isAvailable ? '' : 'disabled') . '>
          ...
          echo '<p class="text-center">No Family rooms available at the moment.</p>';
        }
