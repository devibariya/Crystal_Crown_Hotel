...
<head>
  ...
  <title>Deluxe Rooms - Crystal Crown Hotel</title>
 <link href="images/title.png" rel="icon">
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
 <link href="room_design.css" rel="stylesheet">
...
<body>
  ...
  <!-- Room Section -->
  <section class="py-5">
    <h2 class="section-title">Available Deluxe Rooms</h2>
  ...
  <input type="submit" 
         ...
         ' . ($isAvailable ? '' : 'disabled') . '>
          ...
          echo '<p class="text-center">No Deluxe rooms available at the moment.</p>';
        }
