...
if ($orderId <= 0) {
    die("Invalid lunch order ID.");
}

// Fetch order details
$sql = "SELECT * FROM lunch_orders WHERE id = $orderId";
$result = mysqli_query($conn, $sql);

if (!$result || mysqli_num_rows($result) == 0) {
    die("Lunch order not found.");
}
...
<div class="section">
<div class="section-title">Lunch Details</div>
<div class="info-grid">
